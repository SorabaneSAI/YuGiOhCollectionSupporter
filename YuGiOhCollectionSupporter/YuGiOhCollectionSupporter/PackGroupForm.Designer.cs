namespace YuGiOhCollectionSupporter
{
    partial class PackGroupForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.親ノード名DataGridViewTextBoxColumn.MinimumWidth = 6;
			...
			this.子ノード名DataGridViewTextBoxColumn.MinimumWidth = 6;
			...
			this.含まれる文字DataGridViewTextBoxColumn.MinimumWidth = 6;
